...
/** \brief
  ...
  * @return void
**/
virtual_disk_t* init_disk_raid5(const char * repertoire, int nbDisque){
...
/** \brief
  ...
  * @return void
**/
block_t block_repair(virtual_disk_t *RAID5,uint pos,int idDisk){
  uint iterateur=0;
